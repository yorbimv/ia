...
- **Contexto Excepcional:** Usa `.cursorrules` como fuente de verdad.
...
4. **FASE 4 - Contexto:** Crea `.cursorrules` con reglas de arquitectura y estilo de código.
...
## Reglas de Código
- Mantén los archivos entre 5-15 líneas cuando sea posible.
- Omite autenticación en V1 si es posible para acelerar el lanzamiento.
- Usa el principio de menor privilegio para tokens y accesos.

## Seguridad
- Nunca escribas secretos o API Keys en el código. Usa `.env` y `.gitignore`.
- Valida y sanitiza todas las entradas del usuario.
- Audita y actualiza librerías para evitar vulnerabilidades.
